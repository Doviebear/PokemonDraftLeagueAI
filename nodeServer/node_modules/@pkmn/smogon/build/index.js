...
class Smogon {
        ...
        for (const tierid in data.analyses) {
            ...
            for (const stub of a.sets) {
                ...
                if (set && this.match(species, this.toSet(species, set))) {
                    analysis.sets.push(Object.assign({ name: stub.name, desc: stub.desc }, set));
                }
            }
    ...
    async sets(gen, species, format) {
        ...
        const hackmons = (format === null || format === void 0 ? void 0 : format.endsWith('balancedhackmons')) && !((_a = BANS[gen.num]) === null || _a === void 0 ? void 0 : _a.includes(species.name));
    ...
    name(gen, species, specific = false, stats = false) {
        ...
        if (specific)
            return species.name;
        if (((_a = gen.species.get(species.baseSpecies).cosmeticFormes) === null || _a === void 0 ? void 0 : _a.includes(species.name)) ||
    ...
    fixIVs(gen, set) {
        ...
        if (hp) {
            ...
            if (type && gen.types.getHiddenPower(gen.stats.fill(Object.assign({}, set.ivs), 31)).type !== type.name) {
                if (!set.ivs || (gen.num >= 7 && (!set.level || set.level === 100))) {
                    ...
                    for (const s in type.HPdvs) {
                        ...
                        set.ivs[stat] = (_a = set.ivs[stat]) !== null && _a !== void 0 ? _a : ivs[stat];
                    }
                    const actual = gen.types.getHiddenPower(gen.stats.fill(Object.assign({}, set.ivs), 31));
                    ...
                    for (const s in type.HPivs) {
                        const stat = s;
                        set.ivs[stat] = (_b = set.ivs[stat]) !== null && _b !== void 0 ? _b : type.HPivs[stat];
                    }
                    const actual = gen.types.getHiddenPower(gen.stats.fill(Object.assign({}, set.ivs), 31));
        ...
        if (gen.num <= 2 && set.ivs) {
            ...
            if (expectedHPDV !== gen.stats.toDV((_c = set.ivs.hp) !== null && _c !== void 0 ? _c : 31)) {
