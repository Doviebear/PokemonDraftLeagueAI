...
class Specie {
    constructor(dex, exists, species) {
        ...
        this.formes = (_j = this.formeOrder) === null || _j === void 0 ? void 0 : _j.filter(s => !this.dex.species.get(s).isGigantamax);
        this.prevo =
    ...
    get formeNum() {
        return (this.baseSpecies === this.name
            ...
            : this.dex.species.get(this.baseSpecies).formeOrder.findIndex(name => name === (this.isGigantamax ? this.baseSpecies : this.name)));
    }
    toString() {
        return this.name;
    }
