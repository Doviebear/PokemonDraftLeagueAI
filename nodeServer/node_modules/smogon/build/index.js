...
exports.Analyses = new (class {
     ...
     */
    url(pokemon, gen = 8) {
        return `${exports.Analyses.URL}${exports.Analyses.gen(gen)}/pokemon/${toPokemonAlias(pokemon)}/`;
    }
    /**
    ...
    request(pokemon, gen = 8) {
        return {
            ...
            init: {
                ...
                body: JSON.stringify({ gen: exports.Analyses.gen(gen), alias: toPokemonAlias(pokemon) }),
            },
        };
    }
    /**
